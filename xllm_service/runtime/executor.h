...
#include "common/etcd_client/etcd_client.h"
#include "common/options.h"
#include "common/threadpool.h"
#include "common/xllm/output.h"
#include "instances/global_kvcache_mgr.h"
#include "instances/instance_mgr.h"
#include "request/chat_template/jinja_chat_template.h"
#include "request/request.h"
#include "request/tokenizer/tokenizer.h"
#include "request/tokenizer/tokenizer_args.h"
#include "response_handler.h"
#include "scheduler/scheduling_policy.h"

namespace xllm_service {

class InstanceMgr;

// A Executor for scheduling requests and instances
class Executor final {
 public:
  Executor(const Options& options);
  ~Executor();
